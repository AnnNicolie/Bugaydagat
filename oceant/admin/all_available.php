...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Available Products</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                     ...
                                     <tbody>
    <?php
    $sql = "SELECT s.*, c.title as category_name 
            FROM seafoods s 
            LEFT JOIN categories c ON s.rs_id = c.rs_id 
            ORDER BY s.d_id DESC";
    ...
    echo '<tr>
            ...
            <td>
                <a href="delete_seafoods.php?menu_del='.$rows['d_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                    <i class="fa fa-trash-o" style="font-size:16px"></i>
                </a> 
                <a href="update_product.php?menu_upd='.$rows['d_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
