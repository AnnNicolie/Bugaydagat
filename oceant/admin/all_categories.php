...
<div class="page-wrapper">
                    ...
                    <div class="card card-outline-primary">
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM categories ORDER BY rs_id DESC";
                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-3 col-lg-8 m-b-10">
                                                            <center>
                                                                <img src="Res_img/' . $rows['image'] . '" class="img-responsive radius" style="min-width:150px; min-height:100px;"/>
                                                            </center>
                                                        </div>
                                                    </td>
                                                    <td>' . $rows['date'] . '</td>
                                                    <td>
                                                        <a href="delete_product.php?res_del=' . $rows['rs_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                                                            <i class="fa fa-trash-o" style="font-size:16px"></i>
                                                        </a>
                                                        <a href="update_information.php?res_upd=' . $rows['rs_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
    ...
    <footer class="footer"> © 2025 - Online Seafoods Ordering System </footer>
</div>
</div>
