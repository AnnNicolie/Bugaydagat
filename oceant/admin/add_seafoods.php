        ...
        if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
            ...
            if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
                if ($fsize >= 1000000) {
                    ...
                    $sql = "INSERT INTO seafoods(rs_id, title, slogan, price, img) 
                            VALUES('" . $_POST['res_name'] . "', '" . $_POST['d_name'] . "', '" . $_POST['about'] . "', '" . $_POST['price'] . "', '" . $fnew . "')";
                    mysqli_query($db, $sql);
                    ...
                    $success = '<div class="alert alert-success alert-dismissible fade show">
                                    ...
                                    New seafoods added successfully.
                                </div>';
                }
            } elseif ($extension == '') {
                $error = '<div class="alert alert-danger alert-dismissible fade show">
...
<body class="fix-header">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Types of Products</span></a>
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Products</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="all_available.php">All Availble Products</a></li>
								<li><a href="add_seafoods.php">Add Products</a></li>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Seafoods</h4>
                            </div>
                            <div class="card-body">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label class="control-label">Select Types of Seafoods</label>
            <select name="res_name" class="form-control custom-select">
                <option>--Select Types of Seafoods--</option>
                <?php
                ...
                ?>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_seafoods.php" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
