                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Types of Seafoods</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_categories.php">All Available Seafoods</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_products.php">Add Seafoods</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update</h4>
                            
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from categories where rs_id='$_GET[res_upd]'";
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="all_categories.php" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
